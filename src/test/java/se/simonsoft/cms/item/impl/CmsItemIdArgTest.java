...
public class CmsItemIdArgTest {
	...
	@Test(expected=IllegalArgumentException.class) // Single slash with ^ is not allowed.
	public void testValidateSingleSlashWithCaret() {
		new CmsItemIdArg("x-svn:/svn/demo1^/vvab/graphics/0001.tif");
	}
	...
	@Test(expected=IllegalArgumentException.class)
	public void testValidateColonInParentPath() {
		new CmsItemIdArg("x-svn:/svn:123/demo1/vvab/graphics/0001.tif");
	}
